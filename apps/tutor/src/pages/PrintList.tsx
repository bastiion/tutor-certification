/**
 * Original tutor "print certificates from a name list" form.
 *
 * Moved verbatim from `apps/tutor/App.tsx` (Stage 0) into the new router
 * shell at `/tutor/print`. The certificate-form Cypress spec follows it
 * here unchanged. **Do not refactor in this stage.**
 */
