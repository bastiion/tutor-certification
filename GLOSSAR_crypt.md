...
**External Resource**: [A beginner's guide to Public-Key Cryptography (Cloudflare)](https://www.cloudflare.com/learning/ssl/how-does-public-key-encryption-work/) - good high-level overview.
**External Resource**: [Visualizing Cryptography](https://cryptography.dog/) - excellent interactive visualizer.
